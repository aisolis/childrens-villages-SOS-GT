                                ...
                                <div class="container">
                                  <main>
                                    ...
                                    <img class="img-fluid" src="img/icono1.jpg" alt="">
                                        <h3 style="color:#00AFF0">Preguntas Frecuentes</h3>
                                    </center>
                                    <div style="height: 10px; background-color:#00AFF0 ; "></div>
                                </main>
                                <br>
                                <p >A continuación se presenta una serie de preguntas y respuestas frecuentes que se realizan en 
                                  <strong>Aldeas Infantiles SOS Guatemala.</strong> </p>
                                  <hr>
                                  <div class="col-12 mx-auto">
                					<div class="accordion" id="accordionExample">
                                        <?php $cont = 0; foreach ($pre['post'] as $preguntas): ?>
                						<div class="card">
                							<div class="card-header" id="heading<?php echo $cont;?>">
                								<h5 class="mb-0">
                							<button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapse<?php echo $cont;?>" aria-expanded="true" aria-controls="collapse<?php echo $cont;?>">
                							  <i class="fa fa-heart main"></i><i class="fa fa-angle-double-right mr-3 main"></i><?php echo $preguntas->Pregunta ?>
                							</button>
                						  </h5>
                							</div>
                
                							<div id="collapse<?php echo $cont;?>" class="collapse fade" aria-labelledby="heading<?php echo $cont;?>" data-parent="#accordionExample">
                								<div class="card-body">
